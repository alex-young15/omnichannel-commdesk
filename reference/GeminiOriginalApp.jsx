...
<head>
  ...
  <title>Omnichannel CommDesk - Social Media Inbox</title>
  <!-- Tailwind CSS CDN -->
  <script src="https://cdn.tailwindcss.com"></script>
  <!-- React and ReactDOM CDNs -->
  <script src="https://unpkg.com/react@18/umd/react.development.js" crossorigin></script>
  <script src="https://unpkg.com/react-dom@18/umd/react-dom.development.js" crossorigin></script>
  <!-- Babel CDN for compiling JSX in the browser -->
...
<body class="bg-gray-100 h-screen overflow-hidden">
  ...
  <script type="text/babel">
    ...
    // Lightweight unified SVG Icon Component to ensure offline/sandbox safety
    const Icon = ({ name, size = 16, className = "" }) => {
      const icons = {
        ...
        Pin: <line x1="18" y1="8" x2="22" y2="8" />,
        ...
        ImageIcon: <rect x="3" y="3" width="18" height="18" rx="2" ry="2" />,
        ...
        FileEdit: <path d="M11 4H4a2 2 0 0 0-2 2v14a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2v-7" />,
    ...
    const App = () => {
      ...
      const [transferTab, setTransferTab] = useState('agent'); 
      ...
      // Mock Data adjusted with overdue thresholds and unread reply statuses
      const [sessionsData, setSessionsData] = useState({
        facebook: [
          { id: 4, type: 'facebook', name: 'Summer Sale Post', time: '10:45 AM', title: 'Facebook', timer: '12:34', desc: 'Siti Aminah: Berapa harganya min?', unreadCount: 1, handlingTimeLabel: '08:35', handlingTimeMinutes: 8, isOverdue: false,
            ...
            history: [
                { id: 'c1', sender: 'customer', name: 'Siti Aminah', avatar: 'https://placehold.co/100x100/8b5cf6/ffffff?text=SA', text: 'Berapa harganya min?', time: '1 hour ago', status: 'unread', isHidden: false, replies: [] },
                { id: 'c2', sender: 'customer', name: 'John Doe', avatar: 'https://placehold.co/100x100/3b82f6/ffffff?text=JD', text: 'Bisa kirim ke Papua via udara?', time: '2 hours ago', status: 'replied', agentName: 'Budi Kartika', isHidden: false, replies: [ { id: 'r1', sender: 'agent', text: 'Bisa kak! Silahkan cek ongkir saat checkout ya.', time: '1 hour ago' } ] }
            ]
          },
        ],
        instagram: [
          { id: 5, type: 'instagram', name: '11.11 Promo Post', time: '09:15 AM', title: 'Instagram Post', timer: '02:01', desc: '4 Unread Comments', unreadCount: 4, handlingTimeLabel: '45:10', handlingTimeMinutes: 45, isOverdue: false,
            ...
            history: [
                { id: 'c3', sender: 'customer', name: 'Diana Prince', avatar: 'https://placehold.co/100x100/8b5cf6/ffffff?text=DP', text: 'Ini penipuan atau bukan ya? mau tanya kalau prosedur kpr bagaimana ya', time: '09:15 AM', status: 'pending_review', isHidden: false, replies: [] },
                { id: 'c4', sender: 'customer', name: 'Budi Santoso', avatar: 'https://placehold.co/100x100/3b82f6/ffffff?text=BS', text: 'Berapa cicilan per bulannya min?', time: '10:00 AM', status: 'replied', agentName: 'Budi Kartika', isHidden: false, replies: [ { id: 'r2', sender: 'agent', text: 'Halo kak Budi, untuk cicilan mulai dari 3 jutaan ya.', time: '10:05 AM', status: 'replied' }, { id: 'r3', sender: 'customer', name: 'Budi Santoso', text: 'Wah terjangkau ya, minta brosurnya dong min.', time: '10:15 AM', status: 'unread' } ] },
                { id: 'c_new1', sender: 'customer', name: 'Rina Kusuma', avatar: 'https://placehold.co/100x100/ec4899/ffffff?text=RK', text: 'Lokasi detailnya di mana min?', time: '10:30 AM', status: 'unread', isHidden: false, replies: [] },
                { id: 'c_new2', sender: 'customer', name: 'Ahmad Dani', avatar: 'https://placehold.co/100x100/10b981/ffffff?text=AD', text: 'Bisa KPR bank lain nggak?', time: '10:45 AM', status: 'replied', agentName: 'Budi Kartika', isHidden: false, replies: [ { id: 'r4', sender: 'agent', text: 'Halo kak Ahmad, saat ini promo khusus KPR kami saja ya.', time: '10:50 AM', status: 'replied' } ] },
                { id: 'c_new3', sender: 'customer', name: 'Siska Melly', avatar: 'https://placehold.co/100x100/f59e0b/ffffff?text=SM', text: 'Bagus banget view-nya 😍', time: '11:00 AM', status: 'no_reply_needed', agentName: 'Budi Kartika', isHidden: false, replies: [] },
                { id: 'c_new4', sender: 'customer', name: 'Kevin Wijaya', avatar: 'https://placehold.co/100x100/6366f1/ffffff?text=KW', text: 'Harganya mulai berapaan?', time: '11:15 AM', status: 'unread', isHidden: false, replies: [] },
                { id: 'c_new5', sender: 'customer', name: 'Putri Ayu', avatar: 'https://placehold.co/100x100/ef4444/ffffff?text=PA', text: 'Ada promo DP 0% kah untuk 11.11?', time: '11:30 AM', status: 'unread', isHidden: false, replies: [] },
                { id: 'c_new6', sender: 'customer', name: 'Dimas Pratama', avatar: 'https://placehold.co/100x100/0ea5e9/ffffff?text=DP', text: 'Penipuan nih paling, foto editan.', time: '11:45 AM', status: 'pending_review', isHidden: true, replies: [] }
            ]
          },
          { id: 51, type: 'instagram', name: 'Reza Rahardian (Mention)', time: '10:00 AM', title: 'Instagram Mention', timer: '01:30', desc: '@Brand tolong cek DM ya', unreadCount: 1, handlingTimeLabel: '05:45', handlingTimeMinutes: 5, isOverdue: false,
            ...
            history: [
                { id: 'c5', sender: 'customer', name: 'Reza Rahardian', avatar: 'https://placehold.co/100x100/10b981/ffffff?text=RR', text: '@Brand tolong cek DM ya, ada dokumen yang mau saya tanyakan.', time: '10:00 AM', status: 'unread', isHidden: false, replies: [] }
            ]
          },
          { id: 52, type: 'instagram', name: 'Siska (#BankDance)', time: '09:45 AM', title: 'Instagram Hashtag', timer: '02:00', desc: 'Keren banget promonya #BankDance', unreadCount: 0, handlingTimeLabel: '00:00', handlingTimeMinutes: 0, isOverdue: false,
            ...
            history: [
                { id: 'c6', sender: 'customer', name: 'Siska', avatar: 'https://placehold.co/100x100/ec4899/ffffff?text=SK', text: 'Keren banget promonya #BankDance', time: '09:45 AM', status: 'no_reply_needed', agentName: 'Budi Kartika', isHidden: false, replies: [] }
            ]
          }
        ],
        x: [
          ...
          { id: 61, type: 'x', name: '@alex_gamer', time: '10:35 AM', title: 'X Post', timer: '05:00', desc: 'Mobile app down lagi ya?', unreadCount: 1, handlingTimeLabel: '08:20', handlingTimeMinutes: 8, isOverdue: false,
            ...
            history: [
                { id: 'c7', sender: 'customer', name: '@alex_gamer', avatar: 'https://placehold.co/100x100/f59e0b/ffffff?text=AG', text: '@Brand CS mobile app down lagi ya? Error 205 dari tadi ga bisa transfer.', time: '10:35 AM', status: 'unread', isHidden: false, replies: [] }
            ]
          }
        ],
        linkedin: [
        ...
        youtube: [
          { id: 8, type: 'youtube', name: 'Q3 Earnings Video', time: 'Yesterday', title: 'YouTube', timer: '24:00', desc: 'User123: When will the dividends be paid out?', unreadCount: 1, handlingTimeLabel: '1440:00', handlingTimeMinutes: 1440, isOverdue: false,
            ...
            history: [
                { id: 'c8', sender: 'customer', name: 'InvestorPro', avatar: 'https://placehold.co/100x100/64748b/ffffff?text=IP', text: 'When will the dividends be paid out?', time: 'Yesterday', status: 'unread', isHidden: false, replies: [] }
            ]
          },
        ],
        appstore: [
          { id: 10, type: 'appstore', name: 'TechGuru99', time: 'Yesterday', title: 'App Store', timer: '05:12', desc: 'Great app but needs dark mode.', unreadCount: 1, handlingTimeLabel: 'Overdue 135:12', handlingTimeMinutes: 135, isOverdue: true,
            ...
            history: [
              { id: 'c10', sender: 'customer', text: 'Great app but needs dark mode. It burns my eyes at night.', time: 'Yesterday, 10:00 AM', status: 'unread', isHidden: false }
            ]
          },
        ],
        playstore: [
          { id: 11, type: 'playstore', name: 'AndroidUser1', time: '2 Days Ago', title: 'Play Store', timer: '48:00', desc: 'Tolong perbaiki bug saat scan QRIS', unreadCount: 0, handlingTimeLabel: 'Overdue 74:20', handlingTimeMinutes: 74, isOverdue: true,
            assignmentLevel: 'comment',
            appName: 'BCA Mobile',
            appVersion: 'v2.1.0',
            rating: 2,
            ...
            history: [
              { id: 'c11', sender: 'customer', text: 'Tolong perbaiki bug saat scan QRIS sering loading lama. Sangat mengganggu saat mau bayar di kasir.', time: '2 Days Ago', status: 'replied', agentName: 'Budi Kartika', isHidden: false }
            ]
          },
        ]
      });
      ...
      const renderSidebar = (title, items) => {
        if (!isQueueVisible) {
          return (
            <div className="w-16 border-r border-gray-200 flex flex-col bg-gray-50 items-center transition-all flex-shrink-0 z-10 shadow-inner h-full">
              <div 
        ...
        return (
          <div className="w-[300px] border-r border-gray-200 flex flex-col bg-white flex-shrink-0 transition-all h-full">
            ...
            {activeTab === 'socialmedia' && (
              <div className="border-b border-gray-100 bg-gray-50 flex flex-col">
                <div className="px-3 py-2 flex flex-wrap gap-1.5 border-b border-gray-100/50">
                  ...
                  <button onClick={() => toggleChannel('facebook')} className={`px-2.5 py-1 text-[10px] rounded-full whitespace-nowrap flex items-center space-x-1 ${selectedChannels.includes('facebook') ? 'bg-blue-100 text-blue-700 font-bold' : 'bg-white border border-gray-200 text-gray-600 hover:bg-gray-100'}`}><span>FB</span></button>
                  <button onClick={() => toggleChannel('instagram')} className={`px-2.5 py-1 text-[10px] rounded-full whitespace-nowrap flex items-center space-x-1 ${selectedChannels.includes('instagram') ? 'bg-blue-100 text-blue-700 font-bold' : 'bg-white border border-gray-200 text-gray-600 hover:bg-gray-100'}`}><span>IG</span></button>
                  <button onClick={() => toggleChannel('x')} className={`px-2.5 py-1 text-[10px] rounded-full whitespace-nowrap flex items-center space-x-1 ${selectedChannels.includes('x') ? 'bg-blue-100 text-blue-700 font-bold' : 'bg-white border border-gray-200 text-gray-600 hover:bg-gray-100'}`}><span>X</span></button>
                  <button onClick={() => toggleChannel('youtube')} className={`px-2.5 py-1 text-[10px] rounded-full whitespace-nowrap flex items-center space-x-1 ${selectedChannels.includes('youtube') ? 'bg-blue-100 text-blue-700 font-bold' : 'bg-white border border-gray-200 text-gray-600 hover:bg-gray-100'}`}><span>YT</span></button>
                  <button onClick={() => toggleChannel('linkedin')} className={`px-2.5 py-1 text-[10px] rounded-full whitespace-nowrap flex items-center space-x-1 ${selectedChannels.includes('linkedin') ? 'bg-blue-100 text-blue-700 font-bold' : 'bg-white border border-gray-200 text-gray-600 hover:bg-gray-100'}`}><span>IN</span></button>
                  <button onClick={() => toggleChannel('tiktok')} className={`px-2.5 py-1 text-[10px] rounded-full whitespace-nowrap flex items-center space-x-1 ${selectedChannels.includes('tiktok') ? 'bg-blue-100 text-blue-700 font-bold' : 'bg-white border border-gray-200 text-gray-600 hover:bg-gray-100'}`}><span>TK</span></button>
                  <button onClick={() => toggleChannel('appstore')} className={`px-2.5 py-1 text-[10px] rounded-full whitespace-nowrap flex items-center space-x-1 ${selectedChannels.includes('appstore') ? 'bg-blue-100 text-blue-700 font-bold' : 'bg-white border border-gray-200 text-gray-600 hover:bg-gray-100'}`}><span>App Store</span></button>
                  <button onClick={() => toggleChannel('playstore')} className={`px-2.5 py-1 text-[10px] rounded-full whitespace-nowrap flex items-center space-x-1 ${selectedChannels.includes('playstore') ? 'bg-blue-100 text-blue-700 font-bold' : 'bg-white border border-gray-200 text-gray-600 hover:bg-gray-100'}`}><span>Play Store</span></button>
                </div>
                <div className="px-3 py-2 flex flex-wrap gap-1.5">
                  ...
                  <button onClick={() => toggleType('conversation')} className={`px-2.5 py-1 text-[10px] rounded-full whitespace-nowrap flex items-center space-x-1 ${selectedTypes.includes('conversation') ? 'bg-indigo-100 text-indigo-700 font-bold' : 'bg-white border border-gray-200 text-gray-600 hover:bg-gray-100'}`}><Icon name="MessageSquare" size={10} /> <span>Chats</span></button>
                  <button onClick={() => toggleType('post')} className={`px-2.5 py-1 text-[10px] rounded-full whitespace-nowrap flex items-center space-x-1 ${selectedTypes.includes('post') ? 'bg-indigo-100 text-indigo-700 font-bold' : 'bg-white border border-gray-200 text-gray-600 hover:bg-gray-100'}`}><Icon name="Layout" size={10} /> <span>Posts</span></button>
                  <button onClick={() => toggleType('comment')} className={`px-2.5 py-1 text-[10px] rounded-full whitespace-nowrap flex items-center space-x-1 ${selectedTypes.includes('comment') ? 'bg-indigo-100 text-indigo-700 font-bold' : 'bg-white border border-gray-200 text-gray-600 hover:bg-gray-100'}`}><Icon name="Star" size={10} /> <span>Reviews</span></button>
                </div>
              </div>
            )}
      ...
      return (
        <div className="flex flex-col h-screen bg-[#F0F2F5] font-sans text-slate-700 overflow-hidden select-none">
          {/* Top Navbar */}
            ...
            <div className="flex items-center h-full w-full">
              <div className="flex space-x-1 h-full overflow-x-auto no-scrollbar w-full">
                <button 
                  ...
                  className={`h-full px-5 text-sm flex items-center space-x-1.5 whitespace-nowrap border-b-4 transition-colors relative z-30 ${
                ...
                {mainMenu === 'access_records' && (
                  <div className="flex items-center h-full px-5 text-sm space-x-2 whitespace-nowrap border-b-4 transition-colors border-white font-bold bg-white/20 ml-2 cursor-default">
                    ...
                    <button 
                      ...
                      className="hover:bg-black/20 p-1 rounded-full transition-colors ml-1.5 flex items-center justify-center"
                    >
                      <Icon name="X" size={14} />
                    </button>
                  </div>
          ...
          {/* Main Container */}
          <div className="flex flex-1 overflow-x-auto overflow-y-hidden custom-scrollbar w-full">
            
            {/* 1. Left Sidebar (Narrow Icons) */}
            <aside className="w-14 bg-white border-r border-gray-200 flex flex-col items-center py-4 space-y-6 shadow-sm z-10 flex-shrink-0 h-full">
              <Icon name="Layout" className="text-gray-400 hover:text-[#005CAB] cursor-pointer" size={20} />
              <div onClick={() => setMainMenu('inbox')} className="relative cursor-pointer group" title="Inbox">
                 <Icon name="MessageSquare" className={`${mainMenu === 'inbox' ? 'text-[#005CAB]' : 'text-gray-400 group-hover:text-[#005CAB]'}`} size={20} />
              </div>
              <div onClick={() => setMainMenu('access_records')} className="relative cursor-pointer group" title="Access Records">
                 <Icon name="History" className={`${mainMenu === 'access_records' ? 'text-[#005CAB]' : 'text-gray-400 group-hover:text-[#005CAB]'}`} size={20} />
              </div>
              <Icon name="Star" className="text-gray-400 hover:text-[#005CAB] cursor-pointer" size={20} />
              <div className="mt-auto pb-4">
                <Icon name="Settings" className="text-gray-400 hover:text-[#005CAB] cursor-pointer" size={20} />
              </div>
            </aside>
            ...
            <main className="flex-1 flex flex-col bg-[#F0F2F5] overflow-hidden border-r border-gray-200 min-w-[500px] h-full">
              ...
              {activeTab === 'home' ? (
                <div className="flex-1 flex flex-col items-center justify-center bg-gray-50 text-gray-500 p-6 h-full">
                  <Icon name="Layout" size={64} className="mb-4 text-gray-300" />
                ...
                <div className="flex-1 flex overflow-hidden bg-white h-full">
                  ...
                  <div className="w-48 bg-gray-50 border-r border-gray-200 p-4 space-y-3 overflow-y-auto custom-scrollbar flex-shrink-0 shadow-inner h-full">
                  ...
                  {/* Main CRM Content */}
                  <div className="flex-1 p-8 overflow-y-auto bg-white space-y-8 custom-scrollbar h-full">
                    {/* CRM Header */}
                    <div className="flex items-center gap-4 border-b border-gray-200 pb-6">
                      <div className="w-16 h-16 bg-gray-100 border border-gray-300 rounded shadow-sm flex items-center justify-center">
                        <Icon name="Layout" size={32} className="text-gray-400" />
                      </div>
                      <div>
                      ...
                      <div className="grid grid-cols-2 gap-x-12 gap-y-4 p-6">
                        ...
                        <div className="flex items-center text-xs">
                          ...
                          <div className="flex-1 bg-gray-100 border border-gray-300 rounded px-2.5 py-1.5 text-gray-800 flex justify-between items-center">
                            22/12/1950 <Icon name="Calendar" size={12} className="text-gray-400" />
                          </div>
                        </div>
                        <div className="flex items-center text-xs">
                ...
                <div className="flex-1 flex flex-col bg-gray-50 p-6 space-y-4 h-full">
                                ...
                                <>
                                    <div className="flex items-center justify-between mb-6">
                                        <div className="flex gap-2 flex-1 max-w-md">
                                            ...
                                            <button className="bg-[#2563eb] text-white px-5 py-2 rounded-lg text-sm font-bold shadow-sm hover:bg-blue-700 transition flex items-center gap-1.5"><Icon name="Search" size={16}/> Search</button>
                                        </div>
                                    ...
                                    <div className="border border-gray-200 rounded-lg overflow-hidden">
                                        ...
                                        <div className="bg-gray-50 px-4 py-3 border-t border-gray-200 flex justify-end items-center gap-4 text-sm text-gray-500">
                                            <div className="flex items-center gap-1">
                                                <button className="p-1 hover:text-gray-800 disabled:opacity-50"><Icon name="ChevronLeft" size={16}/></button>
                                                <span className="px-2 py-1 bg-white border border-blue-500 text-blue-600 rounded text-xs font-bold shadow-sm">1</span>
                                                <button className="p-1 hover:text-gray-800"><Icon name="ChevronRight" size={16}/></button>
                                            </div>
                ...
                <div className="flex-1 flex flex-col items-center justify-center bg-white text-gray-500 p-6 h-full">
                  <Icon name="CheckCircle" size={48} className="mb-4 text-green-300" />
                ...
                <div className="flex-1 flex flex-col relative bg-white h-full">
                  ...
                  <div className="h-14 bg-gray-50 border-b border-gray-200 flex items-center px-4 justify-between shadow-sm z-10 flex-shrink-0">
                      ...
                      <div className="flex items-center gap-2">
                          ...
                          >
                              <Icon name="PhoneOff" size={14} /> Release
                          </button>
                          {(activeSession.sessionStatus !== 'handled' && activeSession.postStatus !== 'handled') && (
                              ...
                              >
                                 <Icon name="CheckCircle" size={14} /> Complete
                              </button>
                          )}
                          <Icon name="MoreVertical" size={16} className="text-gray-400 cursor-pointer ml-1" />
                      </div>
                  </div>
                  ...
                  <div className="bg-white border-t border-gray-200 flex-shrink-0 flex flex-col">
                    ...
                    <div className="flex items-center justify-between px-4 py-2 bg-gray-50/50 border-b border-gray-100">
                        <div className="flex items-center space-x-4 text-gray-500">
                          <button className="hover:text-[#005CAB] transition-colors"><Icon name="Smile" size={20} /></button>
                          <button className="hover:text-[#005CAB] transition-colors"><Icon name="ImageIcon" size={20} /></button>
                          <button className="hover:text-[#005CAB] transition-colors"><Icon name="Folder" size={20} /></button>
                          <button className="hover:text-[#005CAB] transition-colors"><Icon name="Scissors" size={20} /></button>
                          <button className="hover:text-[#005CAB] transition-colors"><Icon name="Mic" size={20} /></button>
                          <button className="hover:text-[#005CAB] transition-colors"><Icon name="Video" size={20} /></button>
                        </div>
                        ...
                        <button className="flex items-center gap-1.5 text-xs font-semibold text-gray-500 hover:text-gray-700 bg-white border border-gray-300 px-3 py-1.5 rounded shadow-sm transition-colors">
                            <Icon name="Clock" size={14} /> Message record
                        </button>
                    </div>
                    {/* Input Area */}
                  ...
                  <div className="h-14 bg-gray-50 border-b border-gray-200 flex items-center px-4 justify-between shadow-sm z-10 flex-shrink-0">
                    <div className="flex items-center space-x-3">
                        ...
                        <span className="flex items-center gap-1 text-[10px] text-gray-500 font-medium">
                            <Icon name="MessageSquare" size={12}/> {activeSession.history?.length || 0} Total
                        </span>
                    </div>
                    <div className="flex items-center gap-2">
                      <button 
                      ...
                      >
                         <Icon name="ChevronDown" size={14} /> Next Unread
                      </button>
                      <button 
                        onClick={() => setShowCloseModal(true)}
                        className="px-3 py-1.5 bg-red-50 text-red-600 border border-red-200 rounded-lg text-xs font-bold hover:bg-red-100 transition-colors flex items-center gap-1 shadow-sm"
                    ...
                    <div className="bg-white p-5 rounded-xl shadow-sm border border-gray-200 flex gap-4 max-w-4xl mx-auto">
                        ...
                        <div className="flex-1">
                            <p className="text-[11px] font-bold uppercase tracking-wider text-gray-400 mb-2 flex items-center">
                                <Icon name="Pin" size={12} className="mr-1"/> Original Post Context
                            </p>
                            ...
                            <div className="mt-3 flex items-center gap-4">
                                <a href="#" className="text-xs text-[#005CAB] hover:underline flex items-center gap-1 font-medium"><Icon name="ExternalLink" size={12}/> View original post</a>
                                <button onClick={() => setReplyingToId('post')} className="text-xs text-[#005CAB] hover:underline flex items-center gap-1 font-medium"><Icon name="Reply" size={12}/> Reply to Post</button>
                            </div>
                                ...
                                <div className="flex-1">
                                    <div className="flex items-center justify-between mb-1.5">
                                        ...
                                        <div className="flex items-center gap-1.5 cursor-pointer" onClick={() => !isCommentUnread && handleCommentAction(activeSession.id, comment.id, 'unread')} title="Click to revert to Unread">
                                            {comment.isHidden && <span className="flex items-center gap-1 text-[10px] text-gray-600 bg-gray-200 px-2 py-0.5 rounded-full font-bold border border-gray-300"><Icon name="EyeOff" size={10}/> Hidden</span>}
                                            ...
                                            {comment.status === 'replied' && <span className="flex items-center gap-1 text-[10px] text-green-700 bg-green-50 px-2.5 py-0.5 rounded-full font-bold border border-green-200"><Icon name="CheckCircle" size={10}/> Replied by {comment.agentName || 'Agent'}</span>}
                                            ...
                                            {comment.status === 'pending_review' && <span className="flex items-center gap-1 text-[10px] text-orange-700 bg-orange-50 px-2.5 py-0.5 rounded-full font-bold border border-orange-200"><Icon name="Shield" size={10}/> Pending Review</span>}
                                        </div>
                                    </div>
                                    ...
                                    {/* Post-Level Actions (Like and Block completely removed) */}
                                    <div className="flex flex-wrap items-center gap-4 mt-2 ml-2 text-[11px] font-semibold">
                                        {isCommentUnread ? (
                                            <>
                                                <button onClick={() => setReplyingToId(comment.id)} className="text-blue-600 hover:text-blue-800 transition-colors flex items-center gap-1"><Icon name="Reply" size={13}/> Reply</button>
                                                <button onClick={() => handleCommentAction(activeSession.id, comment.id, 'no_reply_needed')} className="text-gray-600 hover:bg-gray-100 px-2 py-1 rounded transition-colors flex items-center gap-1 -ml-2"><Icon name="CheckCircle" size={13}/> Mark as Handled</button>
                                            </>
                                        ) : (
                                            <>
                                                <span className="text-gray-400 font-normal">{comment.time}</span>
                                                {comment.status !== 'replied' && <button onClick={() => setReplyingToId(comment.id)} className="text-gray-400 hover:text-blue-600 transition-colors flex items-center gap-1"><Icon name="Reply" size={13}/> Reply</button>}
                                            </>
                                        )}

                                        <div className="flex items-center gap-3 ml-auto text-gray-400 border-l border-gray-200 pl-3">
                                            <button onClick={() => handleCommentAction(activeSession.id, comment.id, 'hide')} className="hover:text-gray-700 transition-colors flex items-center gap-1" title="Hide Comment"><Icon name="EyeOff" size={13}/> Hide</button>
                                            <button onClick={() => handleCommentAction(activeSession.id, comment.id, 'pending_review')} className="hover:text-orange-600 transition-colors flex items-center gap-1" title="Record Service Upgrade / TL Review"><Icon name="FileEdit" size={13}/> Record Escalation</button>
                                        </div>
                                    </div>
                                              ...
                                              <div className={`rounded-xl transition-colors ${isReplyUnread ? 'bg-blue-50/40 ring-1 ring-blue-200 p-3 -m-3 shadow-sm' : ''}`}>
                                                  <div className="flex items-center justify-between mb-1">
                                                    <span className={`font-bold text-xs flex items-center gap-1 ${reply.sender === 'agent' ? 'text-[#005CAB]' : 'text-gray-900'}`}>
                                                        {reply.sender === 'agent' ? <><Icon name="User" size={10}/> Your Brand</> : reply.name || comment.name}
                                                    </span>
                                                    ...
                                                    {reply.sender === 'customer' && (
                                                        <div className="flex items-center cursor-pointer" onClick={() => !isReplyUnread && handleCommentAction(activeSession.id, reply.id, 'unread', true, comment.id)}>
                                                            ...
                                                            {reply.status === 'replied' && <span className="flex items-center gap-1 text-[10px] text-green-700 bg-green-50 px-2 py-0.5 rounded-full font-bold"><Icon name="CheckCircle" size={10}/> Handled</span>}
                                                  ...
                                                  {/* Sub-comment Action Bar (Like & Block removed) */}
                                                  {reply.sender === 'customer' && (
                                                      <div className="flex flex-wrap items-center gap-3 mt-1.5 ml-2 text-[10px] font-semibold text-gray-500">
                                                          {isReplyUnread ? (
                                                              <>
                                                                <button onClick={() => setReplyingToId(reply.id)} className="text-blue-600 hover:text-blue-800 transition-colors flex items-center gap-1"><Icon name="Reply" size={11}/> Reply</button>
                                                                <button onClick={() => handleCommentAction(activeSession.id, reply.id, 'no_reply_needed', true, comment.id)} className="hover:text-gray-700 transition-colors flex items-center gap-1"><Icon name="CheckCircle" size={11}/> Handled</button>
                                                              </>
                                                          ) : (
                                                              <>
                                                                <span className="font-normal">{reply.time}</span>
                                                                <button onClick={() => setReplyingToId(reply.id)} className="hover:text-blue-600 transition-colors flex items-center gap-1"><Icon name="Reply" size={11}/> Reply</button>
                                                              </>
                                                          )}
                                                          <div className="flex items-center gap-2 ml-auto border-l border-gray-200 pl-2">
                                                              <button onClick={() => handleCommentAction(activeSession.id, reply.id, 'hide', true, comment.id)} className="hover:text-gray-700 transition-colors flex items-center gap-1" title="Hide"><Icon name="EyeOff" size={11}/> Hide</button>
                                                          </div>
                                                      </div>
                                                  )}
                                                  
                                                  {/* Sub-comment simple timestamp */}
                                                  {reply.sender === 'agent' && (
                ...
                <div className="flex-1 flex flex-col overflow-hidden bg-white h-full">
                  ...
                  <div className="flex-1 p-6 overflow-y-auto bg-white custom-scrollbar h-full">
                     {activeSession.history?.map((msg, idx) => {
                        if (msg.sender === 'customer') {
                            ...
                            return (
                                <div key={msg.id || idx} className="bg-yellow-50 p-5 rounded-lg border border-yellow-200 mb-6 shadow-sm">
                                    ...
                                    {/* Review Actions (Like removed, Create Ticket removed) */}
                                    <div className="flex flex-wrap items-center gap-4 mt-4 text-[11px] font-semibold border-t border-yellow-200/50 pt-3">
                                        ...
                                        <div className="flex items-center gap-3 ml-auto text-gray-400 border-l border-yellow-200 pl-3">
                                            <button onClick={() => handleCommentAction(activeSession.id, msg.id, 'pending_review')} className="hover:text-orange-600 transition-colors flex items-center gap-1" title="Record Escalation"><Icon name="FileEdit" size={13}/> Record Escalation</button>
                                        </div>
                                    </div>
                                </div>
                            )
            ...
            {/* 5. Right Panel: Assistant & Connection (1.5x Enlarge) */}
            <aside className="w-[570px] bg-[#F8FAFC] flex flex-col shadow-inner justify-between border-l border-gray-200 flex-shrink-0 z-10 relative h-full">
              <div className="flex flex-col h-full bg-white overflow-hidden">
                ...
                <div className="flex-1 flex flex-col overflow-hidden bg-white">
                  {activeSubTab === 'assistant' ? (
                    <>
                      ...
                      <div className="flex justify-between items-center px-4 py-3 border-b border-gray-100 overflow-x-auto no-scrollbar gap-5 text-gray-500 flex-shrink-0 bg-white">
                          <div className="flex flex-col items-center gap-1 cursor-pointer hover:text-[#005CAB] group min-w-max">
                              <div className="relative"><Icon name="Info" size={16} /></div>
                              <span className="text-[10px] font-medium group-hover:text-[#005CAB]">Informasi</span>
                          </div>
                          <div className="flex flex-col items-center gap-1 cursor-pointer hover:text-[#005CAB] group min-w-max">
                              <div className="relative"><Icon name="Navigation" size={16} /></div>
                              <span className="text-[10px] font-medium group-hover:text-[#005CAB]">Navigasi</span>
                          </div>
                          <div className="flex flex-col items-center gap-1 cursor-pointer hover:text-[#005CAB] group min-w-max">
                              <div className="relative"><Icon name="AlertTriangle" size={16} /></div>
                              <span className="text-[10px] font-medium group-hover:text-[#005CAB]">Pelanggaran</span>
                          </div>
                          <div className="flex flex-col items-center gap-1 cursor-pointer hover:text-[#005CAB] group min-w-max">
                              <div className="relative">
                                  <Icon name="User" size={16} />
                                  <Icon name="CheckCircle" size={8} className="absolute -bottom-1 -right-1 text-green-500 fill-white bg-white rounded-full" />
                              </div>
                          ...
                          <div className="flex flex-col items-center gap-1 cursor-pointer hover:text-[#005CAB] group min-w-max">
                              <div className="relative"><Icon name="CheckSquare" size={16} /></div>
                      ...
                      <div className="flex-1 overflow-y-auto p-4 space-y-4 bg-gray-50/50 custom-scrollbar">
                         ...
                         <div className="bg-red-50/80 border border-red-200 p-3.5 rounded-xl shadow-sm">
                            <div className="flex items-center justify-between">
                                <div className="flex items-center gap-2 text-red-600 font-bold text-[13px]">
                                    <Icon name="AlertCircle" size={16} className="fill-red-100 text-red-500" />
                                    <span>Emosi pelanggan: tidak puas jalan jenderal gatot subroto mbak ika i...</span>
                                </div>
                                <Icon name="X" size={14} className="text-gray-400 cursor-pointer hover:text-gray-600" />
                            </div>
                            ...
                            <div className="mt-2.5">
                                ...
                                <button className="w-full mt-2.5 py-1.5 border border-gray-300 text-blue-600 bg-white hover:bg-blue-50/50 flex justify-center items-center gap-1.5 rounded-lg text-[11px] font-semibold transition-colors shadow-sm">
                                    <Icon name="ExternalLink" size={12} /> Buka
                                </button>
                            </div>
                         </div>
                         ...
                         <div className="bg-yellow-50 border border-yellow-200 p-3.5 rounded-xl shadow-sm">
                            <div className="flex items-center gap-2 text-yellow-600 font-bold text-[13px]">
                                <Icon name="AlertTriangle" size={16} className="fill-yellow-100 text-yellow-500" />
                         ...
                         <div className="bg-indigo-50/30 border border-indigo-100 p-3.5 rounded-xl shadow-sm">
                            <div className="flex items-center gap-2 text-indigo-900 font-bold text-xs mb-2">
                                <Icon name="MessageCircle" size={14} className="fill-indigo-800 text-indigo-100" />
                            ...
                            <div className="flex items-start gap-2 bg-white border border-indigo-50 rounded-lg p-2.5 mb-3 shadow-sm">
                                <Icon name="MessageSquare" size={12} className="text-indigo-600 mt-0.5 flex-shrink-0" />
                    ...
                    <div className="flex-1 overflow-y-auto p-4 space-y-4 bg-gray-50/50 custom-scrollbar h-full">
                      <div className="space-y-4 pt-2">
                        ...
                        <div className="grid gap-3">
                          ...
                          >
                            ...
                            <Icon name="ExternalLink" size={14} className="text-gray-400 group-hover:text-purple-600 transition-colors" />
                          </a>
                          ...
                          >
                            ...
                            <Icon name="ExternalLink" size={14} className="text-gray-400 group-hover:text-blue-600 transition-colors" />
                          </a>
                          ...
                          >
                            ...
                            <Icon name="ExternalLink" size={14} className="text-gray-400 group-hover:text-green-600 transition-colors" />
                          </a>
                        </div>
                      </div>
                    </div>
